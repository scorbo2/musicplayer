...
(At the time of this writing, 2.9 is the latest available version of the musicplayer code)
...
```shell
java -DEXTENSIONS_DIR=/home/scorbett/.MusicPlayer/extensionJars -jar musicplayer-2.9.jar
```
